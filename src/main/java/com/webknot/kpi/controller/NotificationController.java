...
@RestController
@RequestMapping({"/notifications", "/manager/notifications"})
public class NotificationController {
    ...
    public ResponseEntity<?> markRead(Authentication authentication, @PathVariable("id") String idRaw) {
        try {
            ...
            NotificationService.NotificationPayload payload = notificationService.markRead(authentication, id, false);
            ...
            log.error("Failed to mark notification read id={}", idRaw, e);
    ...
    public ResponseEntity<?> markAllRead(Authentication authentication) {
        try {
            int updated = notificationService.markAllRead(authentication, false);
    ...
    public SseEmitter stream(Authentication authentication,
                             @RequestParam(required = false) String types) {
        return notificationService.subscribe(authentication, types, false);
    }
